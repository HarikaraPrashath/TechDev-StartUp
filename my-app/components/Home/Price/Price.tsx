...
const Price = () => {
  return (
    <div className="pt-16 pb-16 bg-gray-100">
      <h1 data-aos="fade-up" className="text-center text-xl text-blue-950 font-bold">
        Choose The Plan That&apos;s Right For You
      </h1>

      <p data-aos="fade-up"  className="mt-3 items-center text-lg font-medium text-gray-700 w-[90%] sm:w-[70%] md:w-[50%] mx-auto">
