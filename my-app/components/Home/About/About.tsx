    ...
    <div className=' pb-20 '>
        <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center'>
            ...
            <div>
             ...
             <button className="mt-5 inline-flex items-center gap-2 text-[#f68967] text-lg font-bold pb-1 border-b-2 border-[#f68967] hover:text-[#f46f4d] transition-all duration-200">
